    ...
    <div className="flex h-screen bg-[#f8f9fa] font-sans text-gray-800 overflow-hidden">
      ...
      >
        <div>
          ...
          <div className="mb-8 flex items-center h-10 px-3">
            ...
            <div className="hidden md:flex md:group-hover:hidden w-full justify-center">
              <span className="material-symbols-outlined text-[#ba0036] text-[32px]">apartment</span>
            </div>
        ...
        <div className="space-y-3 px-3">
          <button className="w-full flex items-center md:justify-center md:group-hover:justify-start gap-3 bg-[#ba0036] text-white px-3 py-3 rounded-xl text-xs font-bold hover:bg-[#9a002d] transition-colors">
            <span className="material-symbols-outlined text-[22px] min-w-[22px] flex justify-center">add_circle</span>
            <span className="md:hidden md:group-hover:inline text-sm">New Listing</span>
          </button>
          ...
          <div className="pt-3 border-t border-gray-100 space-y-1">
            ...
            <Link href="/dashboard/admin/support" className="flex items-center gap-4 px-3 py-2 rounded-xl text-sm font-semibold text-gray-500 hover:text-gray-900 hover:bg-gray-50">
              <span className="material-symbols-outlined text-[22px] min-w-[22px] flex justify-center">help</span>
              <span className="md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Support</span>
            </Link>
          </div>
        </div>
      </aside>
